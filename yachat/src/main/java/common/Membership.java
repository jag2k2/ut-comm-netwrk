...
public class Membership {
    ...
    public synchronized boolean ScreenNameExists(String screenName){
    ...
    public synchronized void Remove(String memberName) {
        members.removeIf(n -> (n.nameEquals(memberName)));
    }

    public synchronized void Send(String command, DatagramSocket udpSocket) throws IOException {
        for (Member member : members) {
    ...
    public synchronized String acceptMessage(String myName) {
        String acceptString = "";
